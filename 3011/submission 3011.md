...
```text
โจทย์ให้ฉันรับชื่อแม่สี 2 สี แล้วแสดงผลการรวมกันของ 2 สีนั้นได้สีอะไร

Input:
โปรแกรมรับชื่อสี 2 สี

Output:
โปรแกรมแสดงสีที่เกิดจากการรวมกันของแม่สี 2 สี หากมีสีใดสีหนึ่งหรือทั้ง 2 สีไม่ใช่แม่สีให้พิมพ์ Error

Constraints:
ชื่อสีที่รับเข้ามาควรเป็น Red Yellow หรือ Blue หากมีสีใดที่ไม่ใช่ใน 3 สีนี้ให้แสดงผลเป็น Error
```
...
```text
Step 1:รับชื่อสี 2 สี
Step 2:ตรวจว่าเป็นสีแดงกับน้ำเงินไหมถ้าใช่ให้พิมพ์"Violet"
Step 3:ตรวจว่าเป็นสีแดงกับเหลืองไหมถ้าใช่ให้พิมพ์"Orange"
Step 4:ตรวจว่าเป็นสีน้ำเงินกับเหลืองไหมถ้าใช่ให้พิมพ์"Green"
Step 5:ตรวจว่าเป็นสีแดงกับแดงไหมถ้าใช่ให้พิมพ์"Red"
Step 6:ตรวจว่าเป็นสีน้ำเงินกับน้ำเงินไหมถ้าใช่ให้พิมพ์"Blue"
Step 7:ตรวจว่าเป็นสีเหลืองกับเหลืองไหมถ้าใช่ให้พิมพ์"Yellow"
Step 8:ถ้าไม่ใช่ทุกเงื่อนไขให้พิมพ์"Error"
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ if-else เข้ามาเพื่อตรวจสอบเงื่อนไขว่าแต่ละสีที่ได้รับมาตรงกับเงื่อนไขต่างๆที่กำหนดไว้หรือไม่ ถ้าตรงก็ให้แสดงสีนั้นๆที่กำหนดไว้ ถ้าไม่ตรงให้พิมพ์"Error" ฉันทดสอบสีที่เป็นแม่สีตามเงื่อนไขต่างๆและสีที่ไม่ใช่แม่สีด้วยตนเอง
```
...
```text
ตรวจสีที่รับค่าเป็นข้อความที่ต่างสีแต่เป็นแม่สีเหมือนกันรวมกันแล้วได้สีตามที่กำหนดไว้
```
...
```text
ตรวจสีที่รับค่าเป็นข้อความสีเดียวกันรวมกันแล้วได้สีเดิม
```
...
```text
ตรวจสีที่รับค่าเป็นข้อความที่มีสีใดสีหนึ่งไม่ใช่แม่สี
```
