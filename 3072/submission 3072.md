...
```text
โจทย์ให้ฉันรับข้อความมา แล้วนับสระ "a,e,i,o,u" ที่อยู่ในข้อความนั้น แล้วจึงแสดงจำนวนสระที่นับได้

Input:
โปรแกรมรับข้อความ

Output:
โปรแกรมควรพิมพ์สระและจำนวนสระตัวนั้นที่นับได้

Constraints:
สระที่นับ "a,e,i,o,u" นับทั้งตัวพิมพ์ใหญ่และพิมพ์เล็ก
```
...
```text
Step 1:รับค่าข้อความ n
Step 2:ตั้งตัวแปรขึ้นมาเพื่อนับสระของแต่ละตัว และให้ค่าเท่ากับ 0  ไว้
Step 3:ใช้ for loop เพื่อตรวจตัวอักษรทุกตัวใน n 
Step 4:ตรวจว่าตัวอักษรนั้นเป็นสระอะไรหรือไม่ โดยตรวจทั้งตัวพิมพ์เล็กและตัวพิมพ์ใหญ่
Step 5:หากเป็นสระตัวไหนก็บวกเพิ่มในตัวแปรที่ตั้งขึ้นมาของสระตัวนั้นทีละ 1
Step 6:แสดงสระที่มี และจำนวนสระแต่ละตัวที่มีในข้อความ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันรับข้อความ n เข้ามา แล้วตั้งตัวแปรนับสระทุกตัวเป็น 0 ไว้ จากนั้นใช้ for  loop ตรวจตัวอักษรทีละตัวในข้อความ เอาตัวอักษรมาตรวจว่าเป็นสระ a, e, i, o หรือ u (ทั้งพิมพ์เล็กและพิมพ์ใหญ่) หรือไม่ ถ้าตรงกับตัวไหนก็บวกตัวแปรนับของตัวนั้นเพิ่มทีละ 1 แล้วสุดท้ายก็เอาเงื่อนไข if มาตรวจว่าถ้าสระตัวไหนมีค่ามากกว่า 0 ถึงจะพิมพ์สระตัวนั้นออกมา
```
...
```text
ตรวจว่าโปรแกรมนับสระได้ทุกตัว ทั้งพิมพ์ใหญ่และพิมพ์เล็ก
```
...
```text
ตรวจกรณีที่ในข้อความมีสระเพียงแบบเดียวโปรแกรมสามารถแสดงได้แค่ตัวเดียว
```
...
```text
ตรวจกรณีที่ไม่มีสระเลย โปรแกรมจะต้องไม่พิมพ์อะไรออกมา
```
