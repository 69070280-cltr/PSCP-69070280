...
```text
โจทย์ให้ฉันรับจำนวนเต็มเป็นค่าสีในระบบสี RGB สองสีแล้วนำทั้งสองสีมาผสมกันเพื่อให้เกิดเป็นสีใหม่โดยการหาค่าเฉลี่ยของความเข้มสีแต่ละช่อง

Input:
โปรแกรมรับค่าตัวเลขสามตัว คั่นด้วยช่องว่าง แทนค่า R,G,B ของสีที่ 1
โปรแกรมรับค่าตัวเลขสามตัว คั่นด้วยช่องว่าง แทนค่า R,G,B ของสีที่ 2

Output:
โปรแกรมควรแสดงตัวเลขผลลัพธ์ของการผสมสี R,G,B จำนวนสามตัวที่คั่นด้วยช่องว่าง
...
```text
Step 1: รับค่า r,g,b ของสีที่ 1 จากบรรทัดแรก
Step 2: รับค่า r,g,b ของสีที่ 2 จากบรรทัดที่สอง
Step 3: หา r ที่ผสมได้ โดยเอา r ของสองสีมาบวกกันแล้วหารด้วยสองแบบปัดเศษทศนิยมลง
Step 4: หา g ที่ผสมได้ด้วยวิธีเดียวกัน
Step 5: หา b ที่ผสมได้ด้วยวิธีเดียวกัน
Step 6: พิมพ์ค่า r,g,b ที่ผสมได้และคั่นด้วยช่องว่าง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันรับค่า r,g,b ของสีที่ 1 และสีที่ 2 มาเก็บไว้ แล้วคำนวณค่าผสมของสีแต่ละช่องด้วยการเอาค่า r,g,b ของสองสีมาบวกกันแล้วหารด้วย 2 แบบปัดเศษทศนิยมลง (ใช้ //) จากนั้นพิมพ์ค่าทั้ง 3 ค่า แล้วคั่นด้วยช่องว่าง
```
...
```text
ตรวจกรณีทั้งสองสีเป็นค่าเดียวกัน
```
...
```text
ตรวจกรณีที่มีเศษทศนิยมว่าปัดลงหรือไม่
```
...
```text
ตรวจกรณีที่เป็นขอบ ค่าสูงสุดกับค่าต่ำสุด
```
