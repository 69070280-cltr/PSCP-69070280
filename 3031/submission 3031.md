...
```text
โจทย์ให้ฉันรับข้อมูลอัตราการขยายพื้นที่ของน้ำหมึก ซึ่งมีค่าเท่ากับพื้นที่ที่หมึกแผ่ขยายไปต่อหนึ่งวินาที และคำร้องจากผู้คนที่อยากทราบว่าบ้านของพวกเขาจะถูกน้ำท่วมในวินาทีที่เท่าไหร่

Input:
โปรแกรมรับค่าจำนวนเต็ม S ที่แทนพื้นที่ที่น้ำหมึกแผ่ขยายต่อหนึ่งวินาที และ N แทนจำนวนคำร้องจากผู้คน

Output:
โปรแกรมควรพิมพ์เวลาที่บ้านแต่ละหลังของคนที่ยื่นคำร้องจะถูกน้ำท่วมที่วินาทีที่เท่าใด

Constraints:
input เป็นจำนวนเต็ม Output ต้องปัดทศนิยมขึ้นเป็นจำนวนเต็ม
```
...
```text
Step 1:รับค่าจำนวนเต็ม S และ N
Step 2:วนลูปรับค่าพิกัด x , y ของบ้านแต่ละหลังตามจำนวน N 
Step 3:คำนวณพื้นที่วงกลมที่ต้องใช้จนถึงบ้าน แล้วหารด้วย S เพื่อหาเวลา
Step 4:ปัดเวลาให้เป็ฯจำนวนเต็มถัดไป แล้วเก็บคำตอบ จากนั้นก็แสดงผลของทุกบ้าน
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันรับค่า S และ N จากนั้นใช้ for loop เพื่อรับพิกัด x,y ของแต่ละบ้านแล้วคำนวณพื้นที่วงกลมที่น้ำหมึกจะแผ่ขยายด้วยค่า pi=3.1416 แล้วนำพื้นที่ที่ได้หารด้วย S เพื่อหาเวลา ถ้าเวลาไม่เป็นจำนวนเต็มจะปัดขึ้นให้เป็นวินาทีถัดไป จากนั้นเก็บคำตอบของแต่ละบ้านไว้แล้วแสดงผลทั้งหมดในตอนท้าย
```
...
```text
ตรวจว่าเวลาที่ได้มีการปัดทศนิยมขึ้นหรือไม่
```
...
```text
ตรวจว่าสามารถรับค่าและคำนวณค่าได้หลายบ้าน แล้วพิมพ์เวลาออกมาทุกหลัง
```
...
```text
ช่วยตรงโค้ดที่เป็นการปัดเศษขึ้น
```

คุณยังทำอะไรด้วยตนเอง

```text
ฉันเขียนแผน เขียน code บางส่วน และทดสอบ ด้วยตนเองทั้งหมด
```
