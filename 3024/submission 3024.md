...
```text
โจทย์ให้ฉันรับค่าคะแนนรวม และ คะแนนสูงสุดของทั้งสามคน แล้วดูว่าคะแนนสูงสุดกับคะแนนต่ำสุดในทั้งสามคนนี้ห่างกันเกินสองคะแนนหรือไม่

Input:
โปรแกรมรับจำนวนจริงของคะแนนรวมและคะแนนสูงสุด

Output:
โปรแกรมควรพิมพ์ "Surprising" ถ้าคะแนนสูงสุดกับคะแนนต่ำสุดห่างกันเกินสองคะแนน มิฉะนั้นให้พิมพ์ "Not surprising"

Constraints:
input เป็นจำนวนจริง ไม่ทราบคะแนนของแต่ละคน
```
...
```text
Step 1:รับค่าจำนวนจริงของคะแนนรวมของทั้งสามคน และ คะแนนสูงสุด
Step 2:ลองสร้างคะแนนของทั้งสามคนจากทุกค่าที่เป็นไปได้ (0-10)
Step 3:ตรวจว่าคะแนนของทั้งสามคนรวมกันแล้วได้ตรงกับคะแนนรวมที่รับมา และ  มีคะแนนสูงสุดเท่ากับคะแนนที่รับมา
Step 4:ถ้าคะแนนสูงสุดกับคะแนนต่ำสุดห่างกันเกินสองคะแนน ให้พิมพ์"Surprising" 
Step 5:ถ้าคะแนนสูงสุดกับคะแนนต่ำสุดห่างกันไม่เกินสองคะแนนให้พิมพ์"Not sursprising"
```
...
```text
วิธีสุดท้ายของฉันแตกต่างจากวิธีแรก ในตอนแรกฉันรับค่าเป็น int เปลี่ยนไปเป็น float จากนั้นลองสร้างคะแนนของสองคนที่เป็นไปได้ 101 ค่าแล้วนำค่าที่ได้ของแต่ละคน / 10.0 เพื่อให้เป็นทศนิยม 1 ตำแหน่งด้วย จากนั้นนำทั้งสองคะแนนมาลบกับคะแนนรวมเพื่อหาคะแนนของคนที่ 3 และตรวจว่าคะแนนของทั้งสามคนตรงกับเงื่อนไขของคะแนนที่รับมาถูกต้อง จากนั้นนำคะแนนสูงสุดกับคะแนนต่ำสุดมาลบกันเพื่อตรวจว่าห่างกันเกิน 2 คะแนนหรือไม่ 
```
...
```text
ตรวจค่าที่แสดงออกมาได้ตรงกับใน testcase
```
...
```text
ตรวจค่าที่คะแนนเท่ากันทั้งสามคน
```
...
```text
ตรวจค่าที่คะแนนสูงสุดกับต่ำสุดห่างกันได้เกินสองคะแนน
```
...
```text
ช่วยตรวจ เสนอความคิดในการคิดสมการ และดูว่าต้องทำอย่างไรบ้างในทุกจุด
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนแผน และ เขียนcodeในบางส่วน ทดสอบ และส่งด้วยตนเอง
```
