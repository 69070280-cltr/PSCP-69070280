...
```text
โจทย์ให้ฉันรับค่าจำนวนเต็มบวก แล้วหาว่าจำนวนเต็มบวกที่รับมามีเลขใดบ้างที่หารด้วย 10 ลงตัว

Input:
โปรแกรมรับจำนวนเต็มบวก 1 จำนวน ค่า N

Output:
โปรแกรมควรพิมพ์จำนวนเต็มบวกตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว

Constraints:
input เป็นจำนวนเต็ม Output ต้องแสดงจำนวนที่หารด้วย 10 ลงตัว
```
...
Step 2:นำ N ที่รับค่ามาหารด้วย 10
Step 3:แสดงค่า N ที่ถูกหารด้วย 10 ไปเรื่อยๆจนถึง 0
```
...
```text
วิธีสุดท้ายของฉันเหมือนวิธีแรก ฉันใช้ modulo เพื่อใช้แค่ค่าที่หารด้วย 10 ลงตัว
```
...
```text
ตรวจว่าหาร 10 แล้วแสดงผลลดลงทีละ 10
```
...
```text
ตรวจหากค่า N เป็นจำนวนที่มากและไม่ได้ลงท้ายด้วยเลข 0
```
...
```text
ช่วยเขียน code ที่ N ถูกหารแล้วต้องเรียง ไปจนถึง 0
```

คุณยังทำอะไรด้วยตนเอง

```text
ช่วยคิดแผน เขียน code บางส่วน
```
