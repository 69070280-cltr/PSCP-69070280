...
```text
โจทย์ให้ฉันรับข้อความภาษาอังกฤษ แล้วกลับด้านตัวอักษรเป็นแบบตัวพิมพ์เล็กเท่านั้น

Input:
โปรแกรมรับข้อความภาษาอังกฤษ

Output:
โปรแกรมควรแสดงผลข้อความตัวอักษรที่ถูกกลับด้าน
 
Constraints:
output เป็นตัวอักษรแบบพิมพ์เล็ก
```
...
```text
Step 1:อ่านข้อความที่รับมาแล้วทำให้เป็นตัวพิมพ์เล็ก
Step 2:พิมพ์ข้อความที่รับมาแบบกลับด้าน
```
...
```text
วิธีสุดท้ายของฉันเหมือนแผนแรก ฉันรับข้อความมาแล้วแปลงข้อความให้เป็นตัวอักษรตัวพิมพ์เล็กทั้งหมดโดยการใช้ .lower แล้วจึงให้พิมพ์ข้อความนั้นแบบกลับด้านโดยใช้ [::-1] ฉันทดสอบโดยการพิมพ์ตัวอักษรพิมพ์ใหญ่และพิมพ์เล็กด้วยตนเองเพื่อทดสอบว่าโปรแกรมรับค่ามาแล้วได้แปลงเป็นตัวพิมพ์เล็กแล้วข้อความที่แสดงออกมาเป็นตัวอักษรพิมพ์เล็กแบบกลับด้านจริงหรือไม่
```
...
```text
ตรวจว่าโปรแกรมแสดงข้อความแบบกลับด้าน 
```
...
```text
ตรวจว่าข้อความที่รับเป็นตัวอักษรพิมพ์ใหญ่ได้ถูกแปลงเป็นตัวอักษรพิมพ์เล็กแล้ว
```
...
```text
ตรวจว่าข้อความที่รับทั้งตัวพิมพ์ใหญ่และพิมพ์เล็กสามารถแสดงผลได้ปกติ
```
