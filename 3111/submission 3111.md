...
```text
โจทย์ให้ฉันคำนวณยอดที่ต้องชำระของนักเรียน 1 คน และ ถ้านักเรียนเป็นสมาชิกาหกรณ์จะได้รับส่วนลดพิเศษ แต่หากไม่ได้เป็นและมียอดตั้งแต่ 500 บาทขึ้นไปก็จะได้ส่วนลดพิเศษเช่นกัน

Input:
โปรแกรมรับค่าสถานะสมาชิกเป็นตัวอักษรภาษาอังกฤษ 1 ตัว เพื่อระบุสถานะสมาชิก 
โปรแกรมรับจำนวนสินค้าที่ซื้่อ n
โปรแกรมรับราคาสินค้าแต่ละ n ชิ้น

Output:
โปรแกรมควรพิมพ์ยอดสุทธิหลังหักส่วนลด

Constraints:
input ที่รับจำนวนรายการสินค้าที่ซื้อเป็นจำนวนเต็ม และ รับราคาเป็นจำนวนจริง output ต้องแสดงทศนิยมสองตำแหน่งด้วย
```
...
```text
Step 1: รับค่าสถานะสมาชิก M หาเป็นสมาชิกจะเป็น "Y" หากไม่จะเป็น "N"
Step 2:รับค่าจำนวนสินค้า n
Step 3:ใช้ for loop เพื่อวนลูปจำนวน n รอบเพื่อรับราคาสินค้าของแต่ละชิ้น แล้วบวกสะสมเก็บไว้
Step 4:เช็คเงื่อนไขส่วนลดพิเศษถ้าเป็นสมาชิก "Y" จะได้ส่วนลดพิเศษ 5% หากไม่ได้เป็นสมาชิก "N" แต่ซื้อสินค้าราคารวมตั้งแต่500บาทขึ้นไปก็จะได้ส่วนลดพิเศษ 3% จากราคายอดรวมก่อนลด
Step 5:นำราคารวมหลังจากที่ตรวจสอบเงื่อนไขแล้วมาปัดเศษทศนิยม
Step 6:แสดงราคา โดยมีทศนิยมสองตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ for loop เพื่อรับราคาสินค้าแต่ละ n ตัว จากนั้นนำราคาสินค้าแต่ละตัวรวมกันไว้ แล้วใช้ if elif เช็คเงื่อนไขสถานะสมาชิก ถ้าเป็นสมาชิกก็จะนำราคาทั้งหมดลบด้วยราคาทั้งหมดที่คูณอยู่กับ 0.05 หรือถ้าไม่ได้เป็นสมาชิกแต่ซื้อสินค้าตั้งแต่ 500 บาทขึ้นไป ก็จะนำราคาทั้งหมดลบด้วยราคาทั้งหมดที่คูณอยู่กับ 0.03 และหากไม่เข้าเงื่อนไขทั้งสองข้อก็จะแสดงผลราคาสุทธิเดิมที่ไม่ได้ถูกหักส่วนลด จากนั้นควรพิมพ์ราคาสุทธิที่แสดงทศนิยมสองตำแหน่ง
```
...
```text
ตรวจกรณีไม่ได้เป็นสมาชิกสหกรณ์แต่ยอดซื้อถึง500บาท
```
...
```text
ตรวจกรณีไม่ได้เป็นสมาชิกสหกรณ์และยอดซื้อไม่ถึง500บาท
```
