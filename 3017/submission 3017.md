...
```text
โจทย์ให้ฉันรับค่าราคาอาหารและเครื่องดื่มของลูกค้า แล้วแสดงผลจำนวนเงินที่ลูกตค้าต้องจ่ายจากการคำนวณเงินที่รวม VAT และค่าบริการ

Input:
โปรแกรมรับค่าราคาอาหารและเครื่องดื่มเป็นค่า x

Output:
โปรแกรมควรแสดงจำนวนเงินที่รวมVATกับค่าบริการไปแล้ว

Constraints:
input เป็นจำนวนเต็ม , ค่าบริการคิดเป็น 10% ของราคาอาหารและเครื่องดื่ม , ค่าบริการขั้นต่ำ 50 บาทสูงสุดไม่เกิน 1000 บาท , Output เป็นจำนวนจริงที่มีทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1:รับค่าราคาอาหารและเครื่องดื่ม x
Step 2:คำนวณค่าบริการจาก x คูณด้วย 10%
Step 3:ตรวจว่าค่าบริการที่คำนวณมาน้อยกว่า 50 หรือไม่ ถ้าใช่ให้ค่าบริการเท่ากับ 50
Step 4:ตรวจว่าค่าบริการที่คำนวณมามากกว่า 1000 หรือไม่ ถ้าใช่ให้ค่าบริการเท่ากับ 1000
Step 5:คำนวณราคารวมจากการนำ x บวกกับค่าบริการที่ได้ตรวจสอบไปก่อนหน้า
Step 6:คำนวณค่า VAT 7% จากการนำราคารวม คูณด้วย 7%
Step 7:คิดราคาสุทธิจากการนำราคารวมบวกกับค่าVAT
Step 8:แสดงราคาสุทธิทั้งหมดเป็นจำนวนจริงที่มีทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันได้ใช้ if-elif เพื่อตรวจสอบเงื่อนไขราคาค่าบริการที่ต้องบวกเพิ่มเข้าไปจากนั้นนำราคาอาหารบวกกับค่าบริการแล้วนำราคารวมมาคูณ VAT 7% จากนั้นนำราคารวมบวกกับที่คำนวณ VAT 7% จึงได้ออกมาเป็นราคาสุทธิ 
```
...
```text
ตรวจว่าโปรแกรมคำนวณราคาที่รวมกับค่าบริการทั้งหมดแล้วได้ตามที่คิดไว้และตรงกับ test case ที่กำหนดไว้หรือไม่
```
...
```text
ตรวจค่า 1000 บาท เพราะค่าบริการต้องยังอยู่ในช่วงไม่เกิน 1000
```
...
```text
ตรวจค่าสูงกว่า1000 เพราะค่าบริการเกิน1000
```
