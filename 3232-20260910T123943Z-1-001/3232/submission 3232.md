...
```text
โจทย์ให้ฉันรับระยะกระโดด และระยะเป้าหมาย แล้วคำนวณว่ากบจะต้องกระโดดอย่างน้อยกี่ครั้งถึงจะไปถึงระยะเป้าหมาย

Input:
โปรแกรมรับจำนวนเต็ม X และ Y

Output:
โปรแกรมควรแสดงจำนวนขั้นต่ำที่ทำให้ระยะทางรวมมากกว่าเท่ากับระยะ Y และหากไปไม่ถึงให้พิมพ์ "-1"

Constraints:
input รับค่าแบบบรรทัดเดัยว
```
...
```text
Step 1:รับค่า x (ระยะกระโดดครั้งแรก) และ y (ระยะเป้าหมาย)
Step 2:ใช้ for loop เพื่อวนซ้ำ ถ้ายังไม่ถึงระยะ y
Step 3:ถ้าระยะกระโดดน้อยกว่า 1 (กระโดดไปไม่ถึงระยะเป้าหมาย) ให้หยุดแล้วให้จำนวนครั้งเป็น "-1" ทันที
Step 4:แต่ถ้ายังกระโดดได้ ให้บวกระยะกระโดดปัจจุบันกับระยะรวม แล้วเพิ่มจำนวนครั้งทีละ 1 และลดระยะกระโดดลง 2 เมตรสำหรับครั้งถัดไป 
Step 5:พิมพ์จำนวนครั้งขั้นต่ำที่ใชข้ในการกระโดด แต่ถ้าหากไม่ถึงระยะเป้าหมายให้พิมพ์ "-1"
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ while เพื่อวนลูปกระโดดไปเรื่อยๆจนกว่าระยะรวมจะถึงระยะเป้าหมาย y โดยในแต่ละรอบของ loop จะตรวจก่อนว่าระยะกระโดดปัจจุบันน้อยกว่า 1 หรือไม่ ถ้าน้อยกว่า 1 แปลว่ากบกระโดดต่อไม่ได้แล้วจึงให้ค่า count เป็น -1 แล้วใช้ break เพื่ออกจาก loop แต่ถ้ายังกระโดดได้อยู่จะบวกระยะกระโดดปัจจุบันเข้ากับระยะกระโดดรวม แล้วเพิ่ม count ขึ้นทีละ 1 แล้วลดระยะกระโดดปัจจุบันลงทีละ 2 สำหรับรอบถัดไป จากนั้นพิมพ์ค่า count ออกมา
```
...
```text
ตรวจกรณีที่กระโดดครั้งเดียวแล้วไปถึงเป้าหมายพอดี
```
...
```text
ตรวจกรณีที่สามารถกระโดดไปถึงระยะเป้าหมายได้พอดีในการกระโดดครั้งสุดท้าย
```
