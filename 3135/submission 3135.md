...
```text
โจทย์ให้รับค่าจำนวน n คนที่นั่งล้อมกันเป็นวงกลม โดยมีขโมยเป็นคนที่ t จากนั้ันนับไปทีละ k คนและทำตามเงื่อนไขของโจทย์เพื่อหาผลลัพธ์

Input:
โปรแกรมรับจำนวนเต็ม 3 จำนวน n,k,t 

Output:
โปรแกรมควรพิมพ์จำนวนคนที่ได้พิจารณาของขวัญ

Constraints:
input เป็นจำนวนเต็มและรับค่าเป็นแบบบรรทัดเดียว
```
...
```text
Step 1:รับค่าจำนวนเต็ม n k t
Step 2:พิจารณาคนที่ 1
Step 3:นับจำนวนคนที่ถูกพิจารณา
Step 4:ถ้าคนปัจจุบันที่ถูกพิจารณาเป็นคนที่ t ให้หยุด
Step 5:ถ้ายังไม่ใช่ให้ส่งต่อไปเรื่อยๆ
Step 6:ถ้านับเกิน n ให้กลับไปเริ่มที่คนที่ 1
Step 7:ทำซ้ำไปเรื่อยๆจนกว่าจะเจอคนที่ t
Step 8:แสดงจำนวนคนที่ได้พิจารณาของขวัญ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้  while เพื่อวนหาคนที่เป็นขโมย โดยเริ่มจากคนที่ 1 แล้วขยับไปทีละ k คน ถ้าเกินจำนวนคนก็วนกลับไปนับคนที่ 1 และใช้ count นับจำนวนคนที่ถูกพิจารณาเมื่อเจอคนที่ t ก็จะหยุดการทำงาน จากนั้นจะแสดงผลจำนวนคนที่ได้พิจารณาของขวัญ
```
...
```text
ช่วยคิดสมการ และ ดู code บางส่วน
```

คุณยังทำอะไรด้วยตนเอง

```text
ฉันคิดสมการบางส่วน และ เขียน code ทดสอบด้วยตนเอง
```
