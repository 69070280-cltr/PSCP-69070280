...
```text
โจทย์ให้ฉันรับข้อความ และแสดงข้อความในกรอบรูปสี่เหลี่ยม

Input:
โปรแกรมรับข้อความตัวอักษรเป็น a-z, A-Z, 0-9 และช่องว่าง จำนวน 5 บรรทัด

Output:
โปรแกรมควรพิมพ์ข้อความ 7 บรรทัด โดยจะมีช่องว่างระหว่างข้อความและกรอบซ้ายกับกรอบขวาด้านละ 1 ช่อง

Constraints:
output กรอบซ้ายและกรอบขวาต้องห่างกันอย่างน้อย 2 ช่อง
```
...
```text
Step 1: รับข้อความ 5 บรรทัด
Step 2: เทียบข้อความจากที่รับมา 5 บรรทัดว่าข้อความไหนมีความยาวสุด
Step 3: ยึดบรรทัดที่มีข้อความที่ยาวมากที่สุดเป็นความกว้างของกรอบ
Step 4: พิมพ์ขอบบนโดยพิมพ์ "*" เป็นจำนวนข้อความที่ยาวมากที่สุดบวกด้วย 4 (ที่ต้องบวก 4 เพราะมีด้านซ้ายขวาด้านละ 1 ตัว และ ช่องว่างด้านซ้ายขวาด้านละ 1 ช่อง)
Step 5: วนพิมพ์ทีละบรรทัด โดยพิมพ์ "*" ตามด้วยช่องว่าง 1 ช่อง แล้วเติมข้อความ จากนั้นเติมช่องว่างให้ครบตามความกว้างของกรอบ แล้วจึงตามด้วยช่องว่าง 1 ช่องและ "*"
Step 6: พิมพ์ขอบล่างให้มีความกว้างเท่ากับขอบบน
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันรับข้อความมา 5 บรรทัด แล้วใช้ max กับ len เพื่อหาบรรทัดที่มีความยาวมากที่สุดเพื่อให้เป็นความกว้างของกรอบ จากนั้นก็จะพิมพ์ขอบบนด้วย "*" ตามจำนวนความกว้างที่ได้มาจากข้อความที่มีความยาวมากที่สุดบวกด้วย 4 แล้วพิมพ์ทีละบรรทัดโดยเติมช่องว่างให้เท่ากับความกว้าง - ความยาวของบรรทัดนั้น เพื่อให้ขอบตรงกันทุกบรรทัด จากนั้นพิมพ์ขอบล่างให้มีความกว้างเท่ากับขอบบน
```
...
```text
ตรวจกรณีที่ข้อความมีความยาวเท่ากันทุกบรรทัด
```
...
```text
ตรวจกรณีที่มีบรรทัดว่าง และ ความยาวของข้อความไม่เท่ากัน
```
...
```text
ตรวจกรณีที่บรรทัดที่มีความยาวมากที่สุดเป็นบรรทัดสุดท้าย และ มีช่องว่างรวมอยู่ในบรรทัด
```
