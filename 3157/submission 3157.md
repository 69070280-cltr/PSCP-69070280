...
```text
โจทย์ให้ฉันรับจำนวนเต็มหนึ่งตัวที่แทนจำนวนครั้งของการกระทำ และคำสั่ง เพื่อจำลองเกมและหาคะแนนรวมหลังจากทำครบทุกคำสั่ง

Input:
โปรแกรมรับจำนวนเต็มหนึ่งค่า n
โปรแกรมรับคำสั่ง n คำสั่ง(+ หรือ -)

Output:
โปรแกรมควรแสดงคะแนนรวมสุดท้าย

Constrains:
input และ output เป็นจำนวนเต็ม
```
...
```text
Step 1:รับค่าจำนวนเต็ม n
Step 2:กำหนดคะแนนเริ่มต้นเป็น 0
Step 3:รับคำสั่งทีละบรรทัดจนถึงบรรทัดที่ n
Step 4:ถ้าคำสั่งเป็น "+" ให้เพิ่ม 10 คะแนน
Step 5:ถ้าคำสั่งเป็น "-" ให้ลด 5 คะแนน
Step 6:พิมพ์คะแนนรวมทั้งหมด
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันกำหนดให้ total เป็น 0 เพื่อใช้ในการเก็บคะแนนรวม และใช้ for loop วนตามจำนวน n เพื่อรับคำสั่ง( + หรือ - )ทีละบรรทัดจนครบบรรทัดที่ n ถ้าคำสั่งเป็น " + " ก็เพิ่ม 10 คะแนน แต่ถ้าเป็น " - "ก็ลด 5 คะแนน จากนั้นแสดงค่า total ออกมาเพื่อเป็นคะแนนรวมสุดท้าย
```
...
```text
ตรวจกรณีที่มี 1 คำสั่งและคำสั่งเป็น +
```
